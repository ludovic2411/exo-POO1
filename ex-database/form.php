...
public function input_email($blabla){
  return '<p><input type="email" name="'.$blabla.'" value="" required></p>';
}
...
public function input_password($blabla){
  return '<p><input type="password" name="'.$blabla.'" value="" required></p>';
}
public function submit($blabla){
  echo '<p><input type="submit" name="'.$blabla.'" value="envoyer"></p></form>';
}
}
